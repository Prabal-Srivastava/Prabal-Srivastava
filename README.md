...
### 1. [Polyglot Applicaiton witb Microservcies and Cloud](https://github.com/Prabal-Srivastava/devops_project)
A comprehensive DevOps project showcasing:
- Orchestration with Kubernetes EKS Service and 
- Automated deployment to AWS with EKS
- Monitoring and logging integration with Trivy Prometheus and Grafana
